...
public class AccountService implements IAccountService {
 ...
 this.accountDAO = accountDAO;
        ...
        this.logger = logger;
//	accountDAO= accountDAO.loadAccount(accountnumber);
...
//		logger = new Logger();
    ...
    public void setAccountDAO(IAccountDAO accountDAO, ICurrencyConverter currencyConverter, IJMSSender jmsSender, ILogger logger) {
